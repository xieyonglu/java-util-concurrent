 ...
 *
 */
public class ExamDelayQueueTest {

	public static void main(String[] args) throws InterruptedException {
		int studentNumber = 20;
		CountDownLatch countDownLatch = new CountDownLatch(studentNumber + 1); // 20个学生 + 一个EndExam
		...
		students.put(new EndExam(students, 120, countDownLatch, teacherThread)); // 把EndExam放到队列里，实际传到teacher线程是21个数据
